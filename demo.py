# -*- coding: utf-8 -*-
"""
Created on Sun Feb 13 20:56:13 2022
...
def create_metric_descriptor(project_id):
    ...
    project_name = "clever-span-340206"
    descriptor = ga_metric.MetricDescriptor()
    descriptor.type = "custom.googleapis.com/demo_metric" + str(uuid.uuid4())
...
def write_time_series(project_id):
    ...
    series.metric.type = "custom.googleapis.com/demo_metric" + str(uuid.uuid4())
